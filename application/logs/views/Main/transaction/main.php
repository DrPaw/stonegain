                ...
                <section class="content col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="col-lg-2 col-md-2 col-xs-2 col-sm-2">
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 sub-padding">
                            <ul class="sidebar-menu border-right padding-top-50">
                                <li class="sidebar-height border-bottom">
                                    <a href="#" class="sidebar-header">Deposit</a>
                                </li>
                                <li class="sidebar-height padding-top-50">
                                    <a href="#" class="sidebar-header">Withdraw</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-10 col-md-10 col-xs-10 col-sm-10">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 col-padding-0" style="padding-right:10px">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 sub-border sub-height sub-padding">
                                <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3 label-height col-padding-10">Address :</div>
                                <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9 col-padding-5">
                                ...
                                <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9 col-padding-5 line-padding-10">
                                    <input type="text" class="form-control input-border" required name="password">
                                </div>
                                <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3 label-height col-padding-10 line-padding-10">Remark :</div>
                                <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9 col-padding-9 line-padding-10">
                                    <input type="text" class="form-control input-border" required name="remark">
                                </div>

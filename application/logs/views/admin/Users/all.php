                    ...
                    <table id="data-table" class="table table-bordered table-hover data-table">
                        ...
                        <tbody>
                            ...
                            foreach ($users as $row) {
                                ?>
                                <tr>
                                    <td><a href="<?= base_url() ?>users/details/<?= $row['user_id'] ?>"><?php echo $i; ?></a></td>
                                    <td><a href="<?= base_url() ?>users/details/<?= $row['user_id'] ?>"><?php echo $row['username']; ?></a></td>
                                    <td><a href="<?= base_url() ?>users/details/<?= $row['user_id'] ?>"><?php echo $row['email']; ?></a></td>

<section class="content-header padding-15">
	...
	<ol class="breadcrumb">
		<li>
			<a href="<?= base_url() ?>report/money">
				<i class="fa fa-file"></i>Top Transaction</a>
		</li>
	</ol>
</section>
<br>
	...
	<div class="mediumBox">
		<div class='panel panel-default'>
			<div class='panel-heading'>
				<h4 class="whiteTitle" style='display: inline-block;'>Top Transaction</h4>
			</div>
			<div class="tab-content">
				...
				<div class="tab-pane active backgroundcolor-white" id="1">
					<div class='panel-heading'>
						...
						<a href="<?php echo site_url('admin_transaction/add'); ?>" class='btn btn-info pull-right'>
							...
							<table id="data-table" class="table table-bordered table-hover data-table">
                                ...
                                foreach ($internal as $row) {
                                    ?>
										<tr>
											<td>
												<a href="<?= base_url() ?>transactionList/details/<?= $row['transaction_id'] ?>">
													<?php echo $i; ?>
												</a>
											</td>
											<td>

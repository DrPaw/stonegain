						...
						<div class="tab-pane active backgroundcolor-white" id="login">
							<table class='formTable'>
								...
								<tr>
									...
									<td>:
										<?= date("h:i:s a", strtotime($user['preferred_time'])) ?>
									</td>
								</tr>
								<tr>
									<th>Preferred Threshold</th>
									<td>:
										<?= $user['preferred_threshold']; ?>
									</td>
								</tr>
								<tr>
									<th>Referral Link (
										<a href="<?= base_url() ?>admin_user/generate_link/<?= $user['user_id'] ?>">generate new link</a>)</th>
									<td>:
										<?= $user['referral_link']; ?>
									</td>
								</tr>

    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-xs-12 col-sm-12">
            <div class="box box-default">
                ...
                <div class="box-body">
                    <form id="user_form" method="POST" action="<?php echo site_url("admin_user//add"); ?>" >
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" required name="bank_account_number" placeholder="bank account number">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <label>Preferred Online / Active Time</label>
                                <input type="time" class="form-control" required name="preferred_time" placeholder="preferred online / active time">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                <label>Preferred Threshold</label>
                                <input type="number" class="form-control" required name="preferred_threshold" placeholder="preferred threshold">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.status) {
                    ...
                    setTimeout(function () {
                        window.location = "<?= site_url('admin_user/'); ?>";
                    }, 1500);
                } else {

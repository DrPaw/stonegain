...
if (!empty($crypto_wallet)) {
	...
	<div class="col-lg-3col-md-3col-xs-3 col-sm-3 label-height col-padding-10 font-size-14">Frozen Asseta : <?= $crypto_wallet["locked_amount"]?> <?= $crypto_wallet["crypto"]?></div>
